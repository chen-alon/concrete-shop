        ...
        <Box sx={styles.bannerContent}>
          <Box sx={styles.text}>
            ...
            <p>
              ...
              שלך ולאווירה שתרצי ליצור בו. במותג שלי תמצאי סוגים שונים של
              אקססוריז מבטון ונרות בשלל צורות וצבעים, לעיצוב חלל הבית שלך או של
              האהובים שלך.
            ...
            <p>
              <strong>
                ...
                <br /> האנרגיות שאני מקבלת מתהליך הכנת המוצרים והפירגון מכן הוא
                הכוח שדוחף אותי להמשיך לגדול וליצור עבורכן עוד ❤️
                <br />
              </strong>
            </p>
          </Box>
